                ...
                <form action="{{ route('cockpit.xui.update', $xui) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="inbound_id" id="inbound_id" class="form-control @error('inbound_id') is-invalid @enderror" value="{{ old('inbound_id', $xui->inbound_id) }}" min="1" placeholder="Оставьте пустым для автоматического выбора">
